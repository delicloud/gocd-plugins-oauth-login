...
public class Base64 {
    ...
    public static String encodToString(byte[] binaryData) {
    ...
    public static String readImageBase64String(String path) {
        try {
            return "data:image/png;base64," + encodToString(IOUtils.toByteArray(DeliFlowAuthProvider.class.getClassLoader().getResourceAsStream(path)));
        } catch (IOException e) {
    ...
    public Object decode(Object pObject) {
        if (!(pObject instanceof byte[])) {
            ...
            byte[] result = this.decode((byte[]) pObject);
            return result;
        }
    }
    ...
    public static byte[] decodeBase64(String base64Data) throws UnsupportedEncodingException {

        return decodeBase64(base64Data.getBytes("UTF-8"));
    }
    ...
    public Object encode(Object pObject) {
        if (!(pObject instanceof byte[])) {
            ...
            byte[] result = this.encode((byte[]) pObject);
            return result;
        }
    }
